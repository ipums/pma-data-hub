...
## Download an article and run it in R

At the top of every post, you'll find a button like this one:
...
Click it, and you'll receive an R Markdown file containing the full text of the post along with all of the code you'll need to reproduce it.

<aside>
You can run an R Markdown (.Rmd) file in R just like you would run a normal R script (.R). <a href="https://rmarkdown.rstudio.com/lesson-1.html">Click here for more information.</a>
</aside>
