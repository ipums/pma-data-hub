...
In this post, we'll assume that you've already reviewed the [Blog Post Workflow](../blog-post-workflow.html), so you're familiar with the process for creating *a new blog post on a new branch* of the Git repository. 
...
```{r, echo = F}
knitr::include_graphics("images/internal/new_rmarkdown.png")
```
...
```{r, echo = F}
knitr::include_graphics("images/internal/yaml.png")
```
...
```{r, echo = F}
knitr::include_graphics("images/internal/images.png")
```
...
```{r, echo = F}
knitr::include_graphics("images/internal/empty_chunk.png")
```
