...
When you want to apply changes to *several* IPUMS PMA variables, it's usually most efficient to leverage the [across](https://dplyr.tidyverse.org/reference/across.html) function from [dplyr]((https://dplyr.tidyverse.org). We use `across` all the time, but some of our best examples show how to:
